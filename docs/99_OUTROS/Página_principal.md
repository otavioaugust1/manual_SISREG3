...
* Acompanhamento sistemático<s>,</s> dos tetos pactuados entre os municípios; 
...
* Controlar limites de solicitação de procedimentos hospitalares por estabelecimento<s>s</s> de saúde solicitante; 
